...
void Play2State::pause(void)
{
}

void Play2State::resume(void)
{
}

bool Play2State::frameStarted(GameManager* game, const FrameEvent& evt)
{
...
bool Play2State::frameEnded(GameManager* game, const FrameEvent& evt)
{
...
bool Play2State::keyReleased(GameManager* game, const OIS::KeyEvent &e)
{
...
bool Play2State::keyPressed(GameManager* game, const OIS::KeyEvent &e)
{
	// Fill Here -------------------------------------------
	switch (e.key)
	{
...
bool Play2State::mousePressed(GameManager* game, const OIS::MouseEvent &e, OIS::MouseButtonID id)
{
	return true;
}

bool Play2State::mouseReleased(GameManager* game, const OIS::MouseEvent &e, OIS::MouseButtonID id)
{
	return true;
}


bool Play2State::mouseMoved(GameManager* game, const OIS::MouseEvent &e)
{
...
void Play2State::_setLights(void)
{
...
void Play2State::_drawScene(void)
{
	mSceneMgr->setSkyBox(true, "Sky/PlaySkyBox", 5000);
}


void Play2State::_drawGridPlane(void)
{
	// 좌표축 표시
...
void Play2State::_controlCharacter(const Ogre::FrameEvent & evt)
{

}

void Play2State::_inputFile(void)
{
	std::ifstream inFile;
...
void Play2State::_makeTestStagePattern(void)
{
